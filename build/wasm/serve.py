#!/usr/bin/env python3
"""Serve this directory (the packaged bin/Ikemen_GO-Web output) with correct
.wasm MIME and single-range HTTP
...
shell avoids SharedArrayBuffer. Plain `python3 -m http.server` from the
output directory also works (the shell then falls back to a full download).
