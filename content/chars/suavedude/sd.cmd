...
;type = varset
;triggerall = var(59) != 1
;trigger1 = gamemode = "practice" && suavemode = 0 ;Browser port: disabled (uses Ikemen-Plus-Ultra-only 'suavemode' trigger)
;var(59) = 1 ;Disable Boss/Awaken Mode

;[State -1, Training Mode Setting]
;type = varset
;triggerall = var(59) = 1
;trigger1 = gamemode = "practice" && suavemode = 1 ;Browser port: disabled (uses Ikemen-Plus-Ultra-only 'suavemode' trigger)
